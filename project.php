...
<div class="section-div container">
  <h1 class="pb-5">Projects I made</h1>
  <div class="cards">
    <div class="cardproject"><a class="cardlink" href="https://github.com/Turbootzz/webshop1">
    ...
    <div class="cardproject"><a class="cardlink" href="projects/pong">
        <img class="cardimg" src="assets/img/pong1.png" alt="The Pong Game" style="width:100%">
        <div class="cardtext pt-3">
          <h4><b>Pong</b></h4>
          <p>Made in Javascript. You play against an AI and it uses physics. Click to play.</p>
        </div>
      </a>
    </div>
    <div class="cardproject"><a class="cardlink" href="https://github.com/Turbootzz/SystemTH">
    ...
    <!-- </div> -->
    <!-- <div class="cards"> -->
    <div class="cardproject"><a class="cardlink" href="projects/snake">
    ...
    <div class="cardproject"><a class="cardlink" href="https://github.com/Turbootzz/ChatApp">
    ...
    <div class="cardproject"><a class="cardlink" href="https://github.com/Turbootzz/pokemon-api">
        <img class="cardimg" src="assets/img/pokemonapi1.png" alt="Pokedex API" style="width:100%">
        <div class="cardtext pt-3">
          <h4><b>PokeDex API</b></h4>
          <p>Made in Javascript. Uses an pokedex API to pull a pokemon.</p>
        </div>
      </a>
    </div>
  </div>
