...
<head>
    ...
    <link rel="stylesheet" href="assets/css/cobblemon.css">
...
<body>
    <header>
        <ul class="topnav">
            ...
            <li class="right"><a href="/">Turboot Website</a></li>
        </ul>
    </header>
    <main>
        <br>
        ...
        <div id="left">
            <ul>
                ...
                <li>Make sure the mods folder is empty.</li>
                <li>Go back to the zip and copy the content in the mods folder.</li>
                <li>At last go back again to the .minecraft directory and paste the content in the mods folder.</li>
            </ul>
        ...
        <ul id="right">
            <h4>Requirements</h4>
            <li>You will need <a
                    href="https://download.oracle.com/java/17/archive/jdk-17.0.7_windows-x64_bin.exe">Java</a> to be
                able to run the fabric.jar file. (Java 17 is recommended)</li>
            <li>Need to have <a href="https://www.minecraft.net/download/" download>Minecraft (Java Edition)</a>
                installed ofcourse.</li>
            <br>
            <h4>Information</h4>
            <li>The reason we use fabric instead of forge is because of<br>better performance and more functionality.
            </li>
            <br>
            <h4>Tips</h4>
            <li>Improve your minecraft performance by locating more RAM.</li>
        </ul>
    </main>
    <footer>
    </footer>
